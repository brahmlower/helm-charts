...
{{- define "qbittorrent.configsPVCName" -}}
{{- default (printf "%s-configs" (include "qbittorrent.fullname" .)) .Values.persistence.configs.name }}
{{- end }}

{{- define "qbittorrent.downloadsPVCName" -}}
{{- default (printf "%s-downloads" (include "qbittorrent.fullname" .)) .Values.persistence.downloads.name }}
{{- end }}
