...
{{/*
Name of the PersistentVolumeClaim that backs /app/app-data.
Uses persistence.appData.existingClaimName when set, otherwise <fullname>-data.
*/}}
{{- define "papra.appDataClaimName" -}}
{{- if .Values.persistence.appData.existingClaimName }}
{{- .Values.persistence.appData.existingClaimName }}
{{- else }}
{{- printf "%s-data" (include "papra.fullname" .) }}
{{- end }}
{{- end }}

{{/*
Name of the Secret that holds AUTH_SECRET (and optionally DATABASE_ENCRYPTION_KEY).
